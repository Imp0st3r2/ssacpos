...
reportsCtrl.$inject = ['$window','$location','$scope','$compile','report'];

function reportsCtrl($window,$location,$scope,$compile,report) {
	var vm = this;
	report.getReportList().then(function(response){
